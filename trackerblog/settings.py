"""
Django settings for trackerblog project.
...
SECRET_KEY = 'django-insecure-j2pucrse+qr31ax^dkn8%ak&g)gigo96uxwyhvzdf51jfbr+!b'
...
ROOT_URLCONF = 'trackerblog.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['trackerblog/templates',],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'trackerblog.wsgi.application'
